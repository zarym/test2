...
C_SRCS += \
/tmp/scratch/raghu/yocto/bsp/bsps/bsps/pm/xilinx-zcu102-2017.1/components/plnx_workspace/fsbl_hwproj/psu_init.c \
...
src/psu_init.o: /tmp/scratch/raghu/yocto/bsp/bsps/bsps/pm/xilinx-zcu102-2017.1/components/plnx_workspace/fsbl_hwproj/psu_init.c
	@echo 'Building file: $<'
	@echo 'Invoking: ARM A53 gcc compiler'
	aarch64-none-elf-gcc -DARMA53_64 -Wall -O2 -I"/tmp/scratch/raghu/yocto/bsp/bsps/bsps/pm/xilinx-zcu102-2017.1/components/plnx_workspace/fsbl_hwproj" -c -fmessage-length=0 -MT"$@" -Os -flto -ffat-lto-objects -DXPS_BOARD_ZCU102 -I../../fsbl_bsp/psu_cortexa53_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
